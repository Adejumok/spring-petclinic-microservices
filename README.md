...
* Customers, Vets and Visits Services - port http://localhost:4040, http://localhost:4141, and http://localhost:4242 respectively. You can also check Eureka Dashboard 
